...
/**
 * @ngdoc service
 * @name Public.NotificationService
 * @description
 * # NotificationService
...
angular.module('Public')
  .service('NotificationService', function ($notification, CONFIG) {
        ...
        if(json.status !== undefined) {
          ...
          //  case CONFIG.JSON_STATUS_SUCCESS: $notification.success(title, message);break;
           case CONFIG.JSON_STATUS_WARNING: $notification.warning(title, message); break;
            ...
            case 1: $notification.success(title, message);break;
            case -2: $notification.error(title, message); break;
          }
